# routes/search.py
import threading, datetime, pytz, uuid, traceback
...
from api.chat_utils import export_jobs_to_store, continue_chat_session, export_and_update_chat
...
def search():
    try:
        ...
        # ghi đầy đủ traceback vào log của Flask
        current_app.logger.error("Lỗi trong /search:\n" + traceback.format_exc())
